...
namespace FirstWebWithWCF.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/divided", ReplyAction="http://tempuri.org/IService1/dividedResponse")]
        double divided(double num1, double num2);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/divided", ReplyAction="http://tempuri.org/IService1/dividedResponse")]
        System.Threading.Tasks.Task<double> dividedAsync(double num1, double num2);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<FirstWebWithWCF.ServiceReference1.IService1>, FirstWebWithWCF.ServiceReference1.IService1 {
        ...
        public double divided(double num1, double num2) {
            return base.Channel.divided(num1, num2);
        }
        
        public System.Threading.Tasks.Task<double> dividedAsync(double num1, double num2) {
            return base.Channel.dividedAsync(num1, num2);
        }
    }
}
